...
time ./word2vec -train alldata-id-shuf.txt -train-pos ../data/full-train-pos.txt -train-neg ../data/full-train-neg.txt -output vectors.txt -cbow 0 -size 100 -window 10 -negative 5 -hs 0 -sample 1e-3 -threads 8 -binary 0 -iter 20 -min-count 1 -sentence-vectors 1 -nb 0
...
time ./word2vec -train alldata-id-shuf.txt -train-pos ../data/full-train-pos.txt -train-neg ../data/full-train-neg.txt -output vectors.txt -cbow 0 -size 100 -window 10 -negative 5 -hs 0 -sample 1e-3 -threads 8 -binary 0 -iter 20 -min-count 1 -sentence-vectors 1 -nb 1
grep '_\*' vectors.txt | sed -e 's/_\*//' | sort -n > sentence_vectors.txt
